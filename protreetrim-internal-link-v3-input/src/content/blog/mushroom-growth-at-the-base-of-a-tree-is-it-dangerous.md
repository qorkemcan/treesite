...
tags:
  - mushroom growth at tree base florida
  - mushrooms around tree roots
  - tree fungus danger florida
...
That is why the right question is never:
**“Can I get rid of the mushrooms?”**

It is:
**“Why did they appear here in the first place?”**
...
1. look at where the mushrooms are actually growing from  
2. inspect the root flare and lower trunk  
3. check for soft bark, cavities, or missing roots  
4. look for crown thinning or dieback  
5. ask whether the tree has changed lean or stability recently  
6. note whether the fungus is recurring in the same place  
